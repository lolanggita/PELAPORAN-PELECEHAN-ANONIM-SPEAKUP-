...
<body class="bg-gray-100">
    <header class="bg-indigo-900">
        <div class="container mx-auto px-4 py-5 flex items-center justify-between">
            ...
            <nav class="flex items-center gap-3">
                ...
                <a href="#" class="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-indigo-900 hover:bg-slate-100 transition">
    ...
    <!-- SweetAlert2 untuk Notifikasi Validasi Gagal -->
    ...
    @if ($errors->any())
        <script>
            Swal.fire({
                ...
                text: 'Mohon periksa kembali form laporan Anda. Pastikan semua data wajib telah diisi.',
